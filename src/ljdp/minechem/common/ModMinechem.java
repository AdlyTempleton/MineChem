...
public class ModMinechem {
	...
	public static final ResourceLocation ICON_ENERGY = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_power.png");

	public static final ResourceLocation ICON_FULL_ENERGY = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_fullEower.png");

	public static final ResourceLocation ICON_HELP = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_help.png");

	public static final ResourceLocation ICON_JAMMED = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_jammed.png");

	public static final ResourceLocation ICON_NO_BOTTLES = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_noBottles.png");

	public static final ResourceLocation ICON_NO_RECIPE = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_noRecipe.png");

	public static final ResourceLocation ICON_NO_ENERGY = new ResourceLocation(
			ConstantValue.MOD_ID, ConstantValue.ICON_BASE + "i_unpowered.png");
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		System.out.println(TranslationHelper.loadLanguages(
				ConstantValue.LANG_DIR, LANGUAGES_SUPPORTED));
	...
	public void init(FMLInitializationEvent event) {
		...
		TickRegistry.registerScheduledTickHandler(new ScheduledTickHandler(),
				Side.SERVER);
		proxy.registerRenderers();
		logger.info("INIT PASSED");
		LanguageRegistry.instance().addStringLocalization("itemGroup.MineChem",
				"en_US", "MineChem");
	...
	private void DoDungeon() {
		ChestGenHooks ChestProvider = ChestGenHooks
	...
	private void initComputerCraftAddon(FMLPostInitializationEvent event) {
		Object ccMain = event.buildSoftDependProxy("CCTurtle",
				"ljdp.minechem.computercraft.CCMain");
		if (ccMain != null) {
	...
	private void initBOP(FMLPostInitializationEvent event) {
		Object BindBOP = event.buildSoftDependProxy("BiomesOPlenty",
				"ljdp.minechem.common.industrial.BOPModule");
		if (BindBOP != null) {
	...
	public void textureHook(IconRegister icon) {
		TabStateControl.unpoweredIcon = icon
				.registerIcon(ConstantValue.UNPOWERED_ICON);
		MinechemTriggers.outputJammed.icon = icon
				.registerIcon(ConstantValue.JAMMED_ICON);
		MinechemTriggers.noTestTubes.icon = icon
				.registerIcon(ConstantValue.NO_BOTTLES_ICON);
		TabStateControlSynthesis.noRecipeIcon = icon
				.registerIcon(ConstantValue.NO_RECIPE_ICON);
		...
		MinechemTriggers.fullEnergy.icon = icon
				.registerIcon(ConstantValue.FULL_ENERGY_ICON);
	}
